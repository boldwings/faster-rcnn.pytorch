...
# Modified by Jana Pavlasek
#
# A generic image dataset class to easily create new
# datasets.
# --------------------------------------------------------
...
class ImageDataset(imdb):

    """A default image dataset which assumes that the images have the correct
    directory structure."""

    def __init__(self, name, image_set, classes, data_path=None, image_ext='.jpg', year='2000',
                 cleanup=True, use_salt=True, use_diff=True, matlab_eval=False, rpn_file=None, min_size=2):
        """Constructor.

        Args:
            name: The name of the dataset.
            image_set: The name of the image subset (ie test or train)
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join(self._devkit_path, 'results', self._name, 'Main')
    ...
    def _write_voc_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print('Writing {} {} results file'.format(cls, self._name))
